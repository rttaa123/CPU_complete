...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot tb xil_defaultlib.tb xil_defaultlib.glbl -log elaborate.log
}
