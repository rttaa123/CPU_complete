...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../project_130316.gen/sources_1/ip/bus4LZU_0/sources_1/new/header" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../project_130316.gen/sources_1/ip/bus4LZU_0/sources_1/new/header" \
  "../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../project_130316.gen/sources_1/ip/bus4LZU_0/sources_1/new/header" \
